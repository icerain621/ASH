...
| R-08 | 权限策略缺陷导致越权 | 安全 | H | 非授权用户访问敏感接口 | 401/403 异常分布、审计告警 | RBAC + `TestCrossSpaceAPIRegression`（含 runs 控制面 cancel/resume/replay/approve，Sprint BM/CC）；发布窗口抽测 | 后端负责人 | Mitigating |

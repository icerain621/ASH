...
| Ingress / Provider / Hub（VX45） | 读 [`ingress-provider-hub.md`](ingress-provider-hub.md) | `ingressAdapters` · Provider `catalog=org` · Skills `hub=org` |
...
| — | Remote sandbox (DX40) | mock/prefer smoke + optional live skip | [`remote-sandbox-smoke.md`](remote-sandbox-smoke.md) |

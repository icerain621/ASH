...
| [`v4.3-release-scope.md`](v4.3-release-scope.md) | **v4.3** 范围（**已冻结**；DX79–DX84） | 生态薄切片（私有技能目录 / 多区域关闭探测） |
...
| [`v6.6-release-scope.md`](v6.6-release-scope.md) | **v6.6** 范围（**已冻结**；VX61–VX62） | Webhook 投递走 Notifier |
...
| [`v6.7-release-scope.md`](v6.7-release-scope.md) | **v6.7** 范围（**已冻结**；VX71–VX72） | Harness 回显沙箱目录 |
| [`sprint-vx71-harness-backends.md`](sprint-vx71-harness-backends.md) | **VX71** Harness sandboxBackends | ✅ |
| [`sprint-vx72-v67-signoff.md`](sprint-vx72-v67-signoff.md) | **VX72** v6.7 冻结 + 签字 | ✅ |
...
| [`sprint-vx35-backend-enum.md`](sprint-vx35-backend-enum.md) | **VX35** Backend 枚举投影 | ✅ |
| [`sprint-vx36-v63-signoff.md`](sprint-vx36-v63-signoff.md) | **VX36** v6.3 冻结 + 签字 | ✅ |

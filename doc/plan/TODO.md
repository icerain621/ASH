...
| VX72 | v6.7 冻结 + 签字 | `v6.7-release-scope`；`make v6.7-signoff`；tag 人工 | ✅ |
| 详排 | — | [`v6.4-release-scope.md`](v6.4-release-scope.md)（已冻结） · [`v6.5-release-scope.md`](v6.5-release-scope.md)（已冻结） · [`v6.6-release-scope.md`](v6.6-release-scope.md)（已冻结） · [`v6.7-release-scope.md`](v6.7-release-scope.md)（已冻结） · [`v6.x-program.md`](v6.x-program.md) | — |
...
- Sprint DX10：Hybrid 接线（Run/CLI/Knowledge/Scale）
- Sprint DX9：RAG Hybrid 符号索引（SQL 28 / RLS 48；`make rag-hybrid-smoke`）
- Sprint DX14：Waker 控制台 + v2.4 范围冻结（Observability/Scale 面板；`make v2.4-signoff`；tag 人工）
- Sprint DX13：Waker 多职责探针（doctor_subset / kpi_drift；方案 A）
- Sprint DX12：Waker duties 账本（SQL 29 / RLS 50；`make waker-smoke`）

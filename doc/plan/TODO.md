...
| 结论 | v1 自动化门禁达 MVP 可发布水位；**v2 功能 Sprint DH–DV 已收口**（tag `v2.0.0` 待人工）；**v2.1：DW–DX5 已冻结**（tag `v2.1.0` 待人工）；**v2.2：DX6–DX8 已冻结**（tag `v2.2.0` 待人工）；**v2.3：DX9 Hybrid 已落地**（冻结/DX10–DX11 仍可能为未提交 WIP；tag 待人工）；**v2.4：DX12 进行中**（草案，未冻结） |
...
| DX10 | Hybrid 接线（Run/CLI/Knowledge） | prepare rebuild 事件；`ash rag rebuild`；Knowledge/Scale Hybrid 面板 | ⏳ 工作区未提交 |
| DX11 | v2.3 scope 冻结 + 签字 | `v2.3-release-scope`；`make v2.3-signoff`；DX9 Minor 收口；tag 人工 | ⏳ 工作区未提交 |
...
| 详排 | — | v2.1 [`v2.1-release-scope.md`](v2.1-release-scope.md)；v2.2 [`v2.2-release-scope.md`](v2.2-release-scope.md)；v2.3 [`v2.3-release-scope.md`](v2.3-release-scope.md)（草案；冻结仍可能为未提交 WIP）；v2.4 [`v2.4-release-scope.md`](v2.4-release-scope.md)（草案） | — |

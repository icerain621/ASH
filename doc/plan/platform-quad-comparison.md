...
| v6.3 | RPC 嵌入 + Cron 通知适配器 + Backend 枚举 | P10, P18, P21 | **草案**（[`v6.3-release-scope.md`](v6.3-release-scope.md) · VX31–VX36） |
| v6.4+ | 可选单通道 Ingress；Provider 目录；组织 Skills Hub | P17, P09, P19 | 观察 |

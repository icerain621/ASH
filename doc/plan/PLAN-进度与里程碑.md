...
> **代码锚点**：Doctor ALL **53/53** · M3 **11/11** · M4 **6/6** · M5 **4/4** · TR3 **10/10** · SQL rev **27** · RLS **46**（v2 DH–DV；**DW+DX3**；tag 待人工）  
> **归属**：[`plan/`](README.md)  
...
**MVP 功能与自动化门禁已完成**；v2 DH–DV 已收口，v2.1 **DW（ACP）+ DX3（Session 互通）** 已接线。当前并行线：**生产环境验收**（云 RDS / 真实 CI·ExecGo）与 v2.1 增量。

...
> 状态：**hardening 已完成**；**三主题 IA 已落地**；**Agent Chat DSH 对标续推**（SSE/工具卡/Stop/标题）；**后端缺口清单**见下；下一步 = P2 流式助手 或 v5 freeze / v4.1  
> 归属：[`plan/`](README.md)  
...
4. **后端缺口清单**（P2–P5 仍开）：[`../../docs/superpowers/specs/2026-09-15-agent-chat-backend-gaps.md`](../../docs/superpowers/specs/2026-09-15-agent-chat-backend-gaps.md) — 优先 **assistant 流式正文**

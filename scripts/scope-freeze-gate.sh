#!/usr/bin/env bash
# MVP §1 + v2 + … + v4.0: validate release scope doc structure before freeze sign-off.
set -euo pipefail
...
check_scope "$ROOT/doc/plan/v2.7-release-scope.md" "v2.7"
...
check_scope "$ROOT/doc/plan/v4.2-release-scope.md" "v4.2"
check_scope "$ROOT/doc/plan/v4.3-release-scope.md" "v4.3"
check_scope "$ROOT/doc/plan/v5.0-release-scope.md" "v5.0"
check_scope "$ROOT/doc/plan/v6.0-release-scope.md" "v6.0"
check_scope "$ROOT/doc/plan/v6.3-release-scope.md" "v6.3"
check_scope "$ROOT/doc/plan/v6.4-release-scope.md" "v6.4"
check_scope "$ROOT/doc/plan/v6.5-release-scope.md" "v6.5"
check_scope "$ROOT/doc/plan/v6.6-release-scope.md" "v6.6"
check_scope "$ROOT/doc/plan/v6.7-release-scope.md" "v6.7"

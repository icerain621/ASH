...
var Catalog = map[string]Entry{
	...
	"MEMORY_RETENTION_FAILED":   {Domain: "memory", Summary: "Memory retention governance failed"},
	...
	"REPO_CONNECTION_TEST_FAILED":   {Domain: "ci", Summary: "Failed to test repo connection"},

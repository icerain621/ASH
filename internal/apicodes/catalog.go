...
var Catalog = map[string]Entry{
	...
	// auth
	"OIDC_DISABLED":                 {Domain: "auth", Summary: "OIDC login is not enabled"},
	"OIDC_LOGIN_FAILED":             {Domain: "auth", Summary: "Failed to start OIDC authorize redirect"},
	"OIDC_STATE_INVALID":            {Domain: "auth", Summary: "OIDC CSRF state missing or expired"},
	"OIDC_EXCHANGE_FAILED":          {Domain: "auth", Summary: "OIDC code exchange or id_token validation failed"},
	"OIDC_USER_FAILED":              {Domain: "auth", Summary: "Failed to map or JIT-create OIDC user"},
	"OIDC_LINK_CONFLICT":            {Domain: "auth", Summary: "OIDC subject/email already linked to another user"},
	"AUTH_SESSION_REVOKED":          {Domain: "auth", Summary: "Auth session sid has been revoked"},
	"AUTH_SESSION_LOOKUP_FAILED":    {Domain: "auth", Summary: "Failed to load auth session registry"},
	"AUTH_SESSION_CREATE_FAILED":    {Domain: "auth", Summary: "Failed to mint device auth session"},
	"AUTH_SESSION_NOT_FOUND":        {Domain: "auth", Summary: "Auth session sid not found"},
	"AUTH_SESSION_FORBIDDEN":        {Domain: "auth", Summary: "Caller cannot manage this auth session"},
	"AUTH_SESSION_REVOKE_FAILED":    {Domain: "auth", Summary: "Failed to revoke auth session"},
	"AUTH_SESSION_PRIMARY_REQUIRED": {Domain: "auth", Summary: "Device token mint requires a primary session"},
	"AUTH_SCOPE_DENIED":             {Domain: "auth", Summary: "JWT scope does not allow the requested permission"},
	"AUTH_SCOPE_INVALID":            {Domain: "auth", Summary: "Requested device scope exceeds caller permissions"},
	"AUTH_REFRESH_REQUIRED":         {Domain: "auth", Summary: "Use a refresh token to renew the session"},
	"AUTH_REFRESH_TOKEN_MISUSE":     {Domain: "auth", Summary: "Refresh token cannot be used on this endpoint"},
	"AUTH_TOKEN_REPLAY":             {Domain: "auth", Summary: "JWT jti is not current (rotated or outside grace)"},
	...
	"MCP_TOOL_HOOK_DENIED":       {Domain: "tool", Summary: "PreToolUse hook denied MCP execute"},
	...
	"SCORE_APPEAL_FAILED":          {Domain: "evolve", Summary: "Failed to open score appeal"},
	...
	"SPACE_EVALUATION_FAILED":      {Domain: "spaces", Summary: "Failed to compute space dual-core evaluation"},
	...
	"WORKSPACE_LIST_FAILED":           {Domain: "agents", Summary: "Failed to list agent workspaces"},
	"WORKSPACE_CREATE_FAILED":         {Domain: "agents", Summary: "Failed to create agent workspace"},
	...
	"REPLAY_DIGEST_MISMATCH":          {Domain: "interactions", Summary: "Sealed thread digest does not match live fold"},

...
func TestNestedContractSchemasMatchSwagger(t *testing.T) {
	...
	pairs := []struct {
		...
		{"DataPolicyResponse", "internal_api.DataPolicyResponse"},
		{"DataRetentionApplyRequest", "internal_api.dataRetentionApplyRequest"},
		{"DataRetentionApplyResponse", "internal_api.DataRetentionApplyResponse"},

...
func (h *Handler) Register(r *gin.Engine, webDir string) {
	...
	v1.Use(h.rlsMiddleware())
	{
		...
		v1.GET("/quest/stream", h.questStream)
		...
		v1.POST("/runs/:runId/diff/reject", h.rejectRunDiff)
		...
		v1.GET("/spaces/:spaceId/quotas", h.getSpaceQuotas)
		v1.GET("/spaces/:spaceId/audit-report", h.getSpaceAuditReport)
